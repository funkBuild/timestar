...
**State as of 2026-07-31 (last code commit: `d9f721c`, the D-37 snapshot transfer budget):** closed so far — D-1,
D-2, D-3, D-4 (two of three halves; third re-filed as D-19), D-5, D-6, D-7, D-11, D-12,
D-13, D-15, D-16, D-17, D-20, D-22, D-23, D-24, D-28, D-31, D-32, D-33, D-34, D-35, D-37; D-14 materially improved.
...
`d9f721c`) and each carries a named unmeasured part. D-31 and D-32 both closed by finding
...
concurrent transfers, so no existing gate exercises it. Suites at last green: unit 4280,
socket 37.
