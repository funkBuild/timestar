...
| suite | result |
|---|---|
| `./test/timestar_unit_test` (from the build root) | **4107 tests / 419 suites, all passed** (1 disabled — the index-flush durability repro, see debt D-3). Since the D-2/D-3 fixes: **4109 / 420**, nothing disabled |
