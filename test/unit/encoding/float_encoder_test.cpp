...
protected:
    ...
    std::vector<double> generateConstantData(size_t size, double value) {
...
TEST_F(FloatEncoderTest, EncodingBenchmark) {
    ...
    for (size_t size : sizes) {
        ...
        // Benchmark Basic encoder
        {
            ...
            std::cout << std::left << std::setw(15) << "Basic"
                      << std::setw(12) << size
                      << std::setw(12) << avgTime
                      << std::setw(15) << (std::to_string(static_cast<int>(throughputMBps)) + " MB/s")
                      << std::setw(15) << (std::to_string(compressionRatio).substr(0, 4) + "x")
                      << std::endl;
        }
        ...
        if (FloatEncoderSIMD::isAvailable()) {
            ...
            std::cout << std::left << std::setw(15) << "AVX2 SIMD"
                      << std::setw(12) << size
                      << std::setw(12) << avgTime
                      << std::setw(15) << (std::to_string(static_cast<int>(throughputMBps)) + " MB/s")
                      << std::setw(15) << (std::to_string(compressionRatio).substr(0, 4) + "x")
        ...
        if (FloatEncoderAVX512::isAvailable()) {
            ...
            std::cout << std::left << std::setw(15) << "AVX-512"
                      << std::setw(12) << size
                      << std::setw(12) << avgTime
                      << std::setw(15) << (std::to_string(static_cast<int>(throughputMBps)) + " MB/s")
                      << std::setw(15) << (std::to_string(compressionRatio).substr(0, 4) + "x")
...
TEST_F(FloatEncoderTest, DecodingBenchmark) {
    ...
    std::cout << "\n===== DECODING PERFORMANCE BENCHMARK =====\n" << std::endl;
    std::cout << std::left << std::setw(15) << "Decoder"
              << std::setw(12) << "Size"
              << std::setw(12) << "Time (us)"
              << std::setw(15) << "Throughput"
              << std::endl;
...
TEST_F(FloatEncoderTest, ComprehensiveEndToEndBenchmark) {
    ...
    for (const auto& testCase : testCases) {
        ...
        for (size_t idx = 0; idx < encoders.size(); idx++) {
            ...
            auto encodeMs = std::chrono::duration_cast<std::chrono::microseconds>(encodeEnd - encodeStart).count() / 1000.0;
            ...
            std::cout << std::left << std::setw(20) << testCase.name
                      << std::setw(15) << encoderName
                      << std::fixed << std::setprecision(2)
                      << std::setw(12) << encodeMs
                      << std::setw(15) << (std::to_string(static_cast<int>(encodeMBps)) + " MB/s");
            ...
            std::cout << std::setw(12) << decodeMs
                      << std::setw(15) << (std::to_string(static_cast<int>(decodeMBps)) + " MB/s")
                      << std::setw(12) << (std::to_string(compressionRatio).substr(0, 4) + "x")
                      << std::setw(12) << totalMs
                      << std::endl;
        }
...
TEST_F(FloatEncoderTest, PerformanceComparison) {
    ...
    std::cout << "Basic encoder: " << basicTime << " us ("
              << std::fixed << std::setprecision(2) << basicMBps << " MB/s)" << std::endl;
    ...
    if (FloatEncoderSIMD::isAvailable()) {
        ...
        std::cout << "SIMD encoder: " << simdTime << " us ("
                  << std::fixed << std::setprecision(2) << simdMBps << " MB/s, "
                  << (double)basicTime / simdTime << "x speedup)" << std::endl;
    }
    ...
    if (FloatEncoderAVX512::isAvailable()) {
        ...
        std::cout << "AVX-512 encoder: " << avx512Time << " us ("
