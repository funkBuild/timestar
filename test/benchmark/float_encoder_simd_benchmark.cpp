...
void benchmark_all_implementations() {
    ...
    for(const auto& dataset : datasets) {
        ...
        double simd_throughput = simd_available ? 
            (input_bytes / (1024.0 * 1024.0)) / (simd_time / 1000.0) : 0;
        ...
        std::cout << "Original         " << std::setw(8) << original_time 
                  << "  " << std::setw(15) << std::setprecision(1) << original_throughput
                  << "  " << std::setw(11) << original_size
                  << "      1.00x" << std::endl;
        
        std::cout << "Staged Buffer    " << std::setw(8) << staged_time 
                  << "  " << std::setw(15) << std::setprecision(1) << staged_throughput
                  << "  " << std::setw(11) << staged_size
                  << "      " << std::setprecision(2) << (original_time / staged_time) << "x" << std::endl;
        
        if(simd_available) {
            std::cout << "SIMD (AVX2)      " << std::setw(8) << simd_time 
                      << "  " << std::setw(15) << std::setprecision(1) << simd_throughput
                      << "  " << std::setw(11) << simd_size
...
void benchmark_simd_scalability() {
    ...
    for(size_t size : sizes) {
        ...
        std::cout << std::setw(8) << size
                  << "  " << std::setw(12) << std::fixed << std::setprecision(3) << original_ms
                  << "  " << std::setw(8) << simd_ms
