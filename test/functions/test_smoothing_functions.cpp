...
TEST_F(SmoothingFunctionsTest, SMAFunctionEdgeHandling) {
    ...
    FunctionContext context = createContext({{"window", int64_t(3)}, {"edge_handling", std::string("pad_nearest")}});
...
TEST_F(SmoothingFunctionsTest, GaussianSmoothFunctionBasic) {
    ...
    FunctionContext context = createContext({{"window", int64_t(7)}, {"sigma", 1.0}});
    ...
    if (result.size() > 10) {
        ...
        EXPECT_LT(std::abs(result.values[9] - result.values[10]), std::abs(stepValues[9] - stepValues[10]));
    }
}
...
TEST_F(SmoothingFunctionsTest, GaussianSmoothFunctionSymmetric) {
    ...
    FunctionContext context = createContext({{"window", int64_t(5)}, {"sigma", 1.0}});
...
TEST_F(SmoothingFunctionsTest, ParameterValidation) {
    ...
    FunctionContext validSMAContext =
        createContext({{"window", int64_t(5)}, {"edge_handling", std::string("truncate")}});
    ...
    FunctionContext invalidSMAEdge = createContext({{"window", int64_t(5)}, {"edge_handling", std::string("invalid")}});
    ...
    FunctionContext multipleEMAParams = createContext({{"alpha", 0.5}, {"window", int64_t(10)}});
...
TEST_F(SmoothingFunctionsTest, SMAFunctionPadZerosDivisorIsWindowSize) {
    ...
    FunctionContext context = createContext({{"window", int64_t(4)}, {"edge_handling", std::string("pad_zeros")}});
...
TEST_F(SmoothingFunctionsTest, SMAFunctionPadNearestDivisorEquivalent) {
    ...
    FunctionContext context = createContext({{"window", int64_t(4)}, {"edge_handling", std::string("pad_nearest")}});
