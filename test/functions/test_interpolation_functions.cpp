...
protected:
    ...
    DoubleSeriesView getInput() const { return DoubleSeriesView(&timestamps, &values); }

    DoubleSeriesView getLinearInput() const { return DoubleSeriesView(&linearTimestamps, &linearValues); }
