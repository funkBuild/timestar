...
void EngineMetrics::setup(Engine& engine) {
    _metrics.add_group(
        "timestar",
        {
            ...
            sm::make_counter("day_bitmap_memberships_repaired_total", day_bitmap_memberships_repaired_total,
                             sm::description("Series/day memberships restored by the startup day-bitmap repair")),
            sm::make_gauge(
