...
struct SeriesMetadataSync {
    ...
    static std::string generateSeriesKey(const std::string& measurement, const std::map<std::string, std::string>& tags,
...
private:
    ...
    static std::string tagKey(const std::string& measurement, const std::string& tagKey, const std::string& tagValue,
                              uint64_t seriesId);
    static std::string compositeTagKey(const std::string& measurement, const std::map<std::string, std::string>& tags,
                                       uint64_t seriesId);
    static std::string fieldKey(const std::string& measurement, const std::string& field, uint64_t seriesId);
...
public:
    ...
    uint64_t getOrCreateSeriesId(const std::string& measurement, const std::map<std::string, std::string>& tags,
                                 const std::string& field);
    ...
    std::vector<uint64_t> findSeriesByTag(const std::string& measurement, const std::string& tagKey,
                                          const std::string& tagValue);
    ...
    void updateFieldStats(const std::string& measurement, const std::string& field, uint64_t seriesId,
                          const FieldStatsSync& stats);

    std::map<std::string, std::vector<uint64_t>> getSeriesGroupedByTag(const std::string& measurement,
