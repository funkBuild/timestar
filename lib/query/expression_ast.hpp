...
struct ExpressionNode {
    ...
    static std::unique_ptr<ExpressionNode> makeTimeShiftFunction(
        const std::string& queryRef,
...
inline const char* unaryOpToString(UnaryOpType op) {
    switch (op) {
        ...
        case UnaryOpType::RATE: return "rate";
        case UnaryOpType::IRATE: return "irate";
        case UnaryOpType::INCREASE: return "increase";
        case UnaryOpType::FILL_FORWARD: return "fill_forward";
        case UnaryOpType::FILL_BACKWARD: return "fill_backward";
        case UnaryOpType::FILL_LINEAR: return "fill_linear";
        case UnaryOpType::CUMSUM: return "cumsum";
        case UnaryOpType::INTEGRAL: return "integral";
        case UnaryOpType::NORMALIZE: return "normalize";
        default: return "?";
    }
}
...
inline const char* functionToString(FunctionType func) {
    switch (func) {
        ...
        case FunctionType::ROLLING_AVG: return "rolling_avg";
        case FunctionType::ROLLING_MIN: return "rolling_min";
        case FunctionType::ROLLING_MAX: return "rolling_max";
        case FunctionType::ROLLING_STDDEV: return "rolling_stddev";
        case FunctionType::FILL_VALUE: return "fill_value";
        case FunctionType::EMA: return "ema";
        case FunctionType::HOLT_WINTERS: return "holt_winters";
        case FunctionType::ZSCORE: return "zscore";
        case FunctionType::TOPK: return "topk";
        case FunctionType::BOTTOMK: return "bottomk";
        case FunctionType::AS_PERCENT: return "as_percent";
        case FunctionType::AVG_OF_SERIES: return "avg_of_series";
        case FunctionType::SUM_OF_SERIES: return "sum_of_series";
        case FunctionType::MIN_OF_SERIES: return "min_of_series";
        case FunctionType::MAX_OF_SERIES: return "max_of_series";
        case FunctionType::PERCENTILE_OF_SERIES: return "percentile_of_series";
        default: return "?";
    }
}
